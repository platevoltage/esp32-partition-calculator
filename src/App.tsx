  ...
  return (
    <div className="App">
      <div style={{ display: 'flex', flexDirection: 'column'}}>
        ...
        <Table table={table} setTable={setTable} flashSize={flashSize*1024} displayDec={displayDec} rowCount={rowCount} setRowCount={setRowCount}/>
        
        <Options flashSize={flashSize} displayDec={displayDec} setFlashSize={setFlashSize} setDisplayDec={setDisplayDec} table={table} setTable={setTable} rowCount={rowCount} setRowCount={setRowCount} />
